...
// initialize type students variable
type Student = {
    name : string;
    gradesArr : number[]
}
...
function calGradAverage(eachStudent:Student){
...
function displayStudentInfo (eachStudent: Student, average: number, gradeLetter: string) {
    console.log(`\nStudent Information: `);
